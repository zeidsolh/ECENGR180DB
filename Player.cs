...
namespace MirrorBasics
{
    ...
    public class Player : NetworkBehaviour
    {
        ...
        public bool send_obstacle;  // flag set by VoiceMovement

        NetworkMatch networkMatchChecker;

        void Start()
        {
            send_obstacle = false;  // initial flag setting
        ...
        void Update()
        {
            if (isLocalPlayer)
            {
                ...
                if (send_obstacle && streakScore.instance.positivePowerUps())
                {
            ...
            send_obstacle = false;  // flag reset
